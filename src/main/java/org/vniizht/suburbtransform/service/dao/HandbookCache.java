...
public class HandbookCache {
    ...
    public SeasonTrip findTrip(Integer season_tick_code, Integer period, Date date) {
    ...
    public SeasonTrip findTrip(Integer season_tick_code, Integer period) {
    ...
    public HandbookCache() throws Exception {
